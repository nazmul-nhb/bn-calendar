...
| ----------- | ----------------- | ----- |
| Node.js | >= 16.0.0 | Full support (ESM & CJS) |
| Browsers | All modern browsers | Zero DOM dependencies |
| Deno / Bun | All recent versions | Works natively |
| TypeScript | >= 4.7 | Includes built-in declaration types |
