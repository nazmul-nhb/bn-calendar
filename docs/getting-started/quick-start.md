...
- Learn how to create dates in depth: [Creating Dates](../guide/creating-dates.md)
- Explore calendar variants: [Calendar Variants](./calendar-variants.md)
- Check complete API docs: [Constructor API](../api/constructor.md)
:::
